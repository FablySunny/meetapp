...
export default function LoginPage() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', background: '#0a0a0b', color: 'white' }}>
      ...
      <button onClick={signInWithGoogle} style={{ padding: '14px 32px', background: 'white', color: 'black', border: 'none', borderRadius: '8px', fontSize: '16px', cursor: 'pointer', fontWeight: '600' }}>Sign in with Google</button>
    </div>
  )
}